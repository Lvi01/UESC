...
public class Player extends Entity{
	...
	public Player(float x, float y, int width, int height, Playing playing) {
		...
		loadAnimations();
		initHitbox(x + xDrawOffset, y + yDrawOffset, (int) (19 * Game.SCALE),(int)( 37 * Game.SCALE)); //AAAAAAAAAAAAAAAAAAARRUMAR HITBOX DO BICHO
		initAttackBox();
	}
	...
	private void updateAttackBox() {
		if (right)
			...
			attackBox.x = hitbox.x - hitbox.width - 20 * Game.SCALE   - (int) (Game.SCALE * 10);
	...
	public void render(Graphics g, int LvlOffset) {
		...
		g.drawImage(animations[state][aniIndex], (int)(hitbox.x - xDrawOffset - 5) - LvlOffset + flipX, (int)(hitbox.y - yDrawOffset), width * flipW, height, null);
